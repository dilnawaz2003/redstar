...
type GetWorkspaceInvitationGroupByPayload<T extends WorkspaceInvitationGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<WorkspaceInvitationGroupByOutputType, T['by']> & {
...
export type WorkspaceInvitationWhereInput = {
    ...
    status?: Prisma.StringFilter<"WorkspaceInvitation"> | string;
...
export type WorkspaceInvitationScalarWhereWithAggregatesInput = {
    ...
    status?: Prisma.StringWithAggregatesFilter<"WorkspaceInvitation"> | string;
...
export type WorkspaceInvitationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "workspaceId" | "email" | "token" | "role" | "invitedById" | "expiresAt" | "status" | "acceptedAt" | "createdAt", ExtArgs["result"]["workspaceInvitation"]>;
...
export interface WorkspaceInvitationFieldRefs {
    ...
    readonly status: Prisma.FieldRef<"WorkspaceInvitation", 'String'>;
...
export {};
//# sourceMappingURL=WorkspaceInvitation.d.ts.map